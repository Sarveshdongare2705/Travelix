...
<body>
    ...
    <div class="heading" style="background: url(images/packages.jpg);">
        <span>Packages</span>
    </div><br><br>
    <div class="categories">
        <br><br>
        <div class="category">
                <div class="image" style="background: url('images/adventure.jpg');"><h3>Adventure Travel</h3>
                    <a href="places2.php?category=adventure" class="btn">Check Places</a>
        </div></div><br><br>
        <div class="category">

            <div class="image" style="background: url('images/wildlife.jpg');"><h3>Wildlife Safaris</h3>
                <a href="places2.php?category=wildlifesafaris" class="btn">Check Places</a>
        </div></div><br>
    <br><br>
    <div class="category">

        <div class="image" style="background: url('images/city.jpg');"><h3>City Explorations</h3>
    ...
    <br><br>
        <div class="category">
                ...
                <div class="image" style="background: url('images/winter.jpg');"><h3>Winter Escapes</h3>
                    <a href="places2.php?category=winterescapes" class="btn">Check Places</a>
                </div></div><br>
        <br><br>
        <div class="category">

            <div class="image" style="background: url('images/Taj Mahal.jpg');"><h3>Wonders of the world</h3>
