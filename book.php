...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $rating =$row['rating'];
                    for ($i = 1; $i <= 5; $i++) {
                        if ($i <= $rating) {
                            echo '<span class="star"><i class="fas fa-star"></i></span>'; // Full star} else {
                    ...
                    echo '</div>';
                    echo '</div>';} else {echo "No reviews yet.";}}
                            }}
?>
</div></div><br><br><br><br>
<div class="heading" style = "font-weight:bold; font-size:60px;">
...
<div class="image-search">
    <form action="" class="image-form">
        <input type="text" id="search-input" readonly  style="border: 1px solid black; width:200px; height:40px; border-radius:20px; padding:10px;margin-left:500px">
