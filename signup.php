...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $country = $_POST["country_register"];
    $dob = $_POST["dob_register"];
    $mobile = $_POST["mobile_register"];
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        $sql = "INSERT INTO `users` (`user_name`, `password`,`country`,`dob`,`mobile`) VALUES ('$username', '$password','$country','$dob','$mobile');";
    ...
    <div class="cover">
      <div class="front">
        ...
        <div class="text">
          ...
          <span class="text-2">Let's start Travel</span></div></div></div>
    <div class="forms">
        ...
        <form action="#" method = "POST">
            <div class="input-boxes">
              ...
              <div class="input-box">
                ...
                <input type="text" placeholder="Country of Residence" required  name="country_register">
              </div>
              <div class="input-box">
                <i class="far fa-calendar"></i>
                <input type="date" placeholder="Date Of Birth" required  name="dob_register">
              </div>
              <div class="input-box">
                <i class="fas fa-mobile"></i>
                <input type="" placeholder="Mobile Number" required  name="mobile_register" minlength="12">
              </div>
              <div class="input-box">
